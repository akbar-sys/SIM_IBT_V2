            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li><a href="{{ url('organization') }}">Organisasi</a></li>
        ...
        <div class="animated fadeIn">      
            <div class="card">
                <div class="card-header">
                    <div class="pull-left">
                        <strong>Edit Organisasi</strong>
                    </div>
                    <div class="pull-right">
                        <a href="{{ url('organization') }}" class="btn-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            {{-- <form action="{{ url('organization/'.$datax->id) }}" method="post"> --}}
                            <form action="{{ url('organization/'.$datax->id) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row">
